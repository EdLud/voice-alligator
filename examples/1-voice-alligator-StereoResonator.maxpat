    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1020.0, 375.0, 89.0, 20.0 ],
                    "presentation_linecount": 3,
                    "text": "ext-busy signal"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 792.0, 351.0, 226.0, 88.0 ],
                    "range": [ 0.001, 1.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1020.0, 285.0, 42.0, 20.0 ],
                    "text": "ADSR"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "bang" ],
                    "patching_rect": [ 792.0, 255.0, 226.0, 88.0 ],
                    "range": [ 0.001, 1.0 ]
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 214.0, 77.0, 38.0, 22.0 ],
                    "text": "p seq"
                }
            },
            {
                            ...
                            "boxes": [
                                {
                                    "box": {
                                        ...
                                        "patching_rect": [ 504.0, 176.0, 141.0, 22.0 ],
                                        "numoutlets": 3,
                                        "id": "obj-33",
                                        "outlettype": [ "", "", "" ],
                                        "numinlets": 2,
                                ...
                                },
                                {
                                    "box": {
                                        "maxclass": "newobj",
                                        "text": "gen @title go.onepole.hz",
                                        "patching_rect": [ 234.0, 185.0, 141.0, 22.0 ],
                                        "numoutlets": 3,
                                        "id": "obj-30",
                                        "outlettype": [ "", "", "" ],
                                        "numinlets": 2,
                                ...
                                },
                                {
                                    "box": {
                                        "maxclass": "newobj",
                                        "text": "3000",
                                        "patching_rect": [ 356.0, 152.0, 35.0, 22.0 ],
                                        "numoutlets": 1,
                                        "id": "obj-48",
                                        "outlettype": [ "" ],
                                        "numinlets": 0
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-1", 1 ],
                    "midpoints": [ 668.0, 480.0, 1154.0234375, 480.0, 1154.0234375, 171.0, 1130.5, 171.0 ],
                    "order": 0,
                    "source": [ "obj-20", 0 ]
                }
            },
