...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 725.0, 410.0, 301.0, 20.0 ],
									"text" : "< note looper records frequencies instead of midi notes"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 1 ],
									"midpoints" : [ 241.0, 613.0, 310.0, 613.0, 310.0, 550.0, 260.5, 550.0 ],
									"source" : [ "obj-33", 1 ]
								}
